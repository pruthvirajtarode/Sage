/**
 * SAGE AI - Client Embed Script
 * This script dynamically creates the chat button and iframe for the SAGE AI widget.
 */
(function () {
    // Detect script origin to find where SAGE AI is hosted
